...
set_property IOSTANDARD  [get_ports {}]
# MC1-15
set_property PACKAGE_PIN W9 [get_ports Add_12]
set_property IOSTANDARD LVCMOS33 [get_ports Add_12]
# MC1-16
set_property PACKAGE_PIN V9 [get_ports Add_1]
set_property IOSTANDARD LVCMOS33 [get_ports Add_1]
# MC1-17
set_property PACKAGE_PIN Y9 [get_ports Add_10]
set_property IOSTANDARD LVCMOS33 [get_ports Add_10]
# MC1-18
set_property PACKAGE_PIN V8 [get_ports Add_3]
set_property IOSTANDARD LVCMOS33 [get_ports Add_3]
# MC1-19
set_property PACKAGE_PIN R6 [get_ports Add_8]
set_property IOSTANDARD LVCMOS33 [get_ports Add_8]
# MC1-20
set_property PACKAGE_PIN V7 [get_ports Add_5]
set_property IOSTANDARD LVCMOS33 [get_ports Add_5]
# MC1-21
set_property PACKAGE_PIN T6 [get_ports Add_6]
set_property IOSTANDARD LVCMOS33 [get_ports Add_6]
# MC1-22
set_property PACKAGE_PIN W7 [get_ports Add_7]
set_property IOSTANDARD LVCMOS33 [get_ports Add_7]
# MC1-23
set_property PACKAGE_PIN U6 [get_ports Add_4]
set_property IOSTANDARD LVCMOS33 [get_ports Add_4]
# MC1-24
set_property PACKAGE_PIN Y8 [get_ports Add_9]
set_property IOSTANDARD LVCMOS33 [get_ports Add_9]
# MC1-25
set_property PACKAGE_PIN V5 [get_ports Add_2]
set_property IOSTANDARD LVCMOS33 [get_ports Add_2]
# MC1-26
set_property PACKAGE_PIN Y7 [get_ports Add_11]
set_property IOSTANDARD LVCMOS33 [get_ports Add_11]
# MC1-27
set_property PACKAGE_PIN T5 [get_ports Add_0]
set_property IOSTANDARD LVCMOS33 [get_ports Add_0]
# MC1-28
set_property PACKAGE_PIN W6 [get_ports {}]
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC1-29
set_property PACKAGE_PIN U5 [get_ports DAC_clk]
set_property IOSTANDARD LVCMOS33 [get_ports DAC_clk]
# MC1-30
set_property PACKAGE_PIN W5 [get_ports {}]
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC1-31
set_property PACKAGE_PIN AA5 [get_ports DAC_din]
set_property IOSTANDARD LVCMOS33 [get_ports DAC_din]
# MC1-32
set_property PACKAGE_PIN R4 [get_ports DAC_reset]
set_property IOSTANDARD LVCMOS33 [get_ports DAC_reset]
# MC1-33
set_property PACKAGE_PIN AB5 [get_ports DAC_sync]
...
set_property IOSTANDARD  [get_ports {}]
# MC1-37
set_property PACKAGE_PIN AB7 [get_ports ack_0]
#
# MC1-38
set_property PACKAGE_PIN Y4 [get_ports ack_1]
#
# MC1-39
set_property PACKAGE_PIN AB6 [get_ports ack_2]
#
# MC1-40
set_property PACKAGE_PIN AA4 [get_ports ack_3]
#
# MC1-41
set_property PACKAGE_PIN R3 [get_ports ack_4]
#
# MC1-42
set_property PACKAGE_PIN Y6 [get_ports ack_5]
#
# MC1-43
set_property PACKAGE_PIN R2 [get_ports ack_6]
#
# MC1-44
set_property PACKAGE_PIN AA6 [get_ports ack_7]
#
# MC1-45
set_property PACKAGE_PIN Y3 [get_ports ack_8]
set_property IOSTANDARD LVCMOS33 [get_ports ack_8]
# MC1-46
set_property PACKAGE_PIN AA8 [get_ports req_0]
set_property IOSTANDARD LVCMOS33 [get_ports req_0]
# MC1-47
set_property PACKAGE_PIN AA3 [get_ports req_1]
set_property IOSTANDARD LVCMOS33 [get_ports req_1]
# MC1-48
set_property PACKAGE_PIN AB8 [get_ports req_2]
set_property IOSTANDARD LVCMOS33 [get_ports req_2]
# MC1-49
set_property PACKAGE_PIN U2 [get_ports req_3]
set_property IOSTANDARD LVCMOS33 [get_ports req_3]
# MC1-50
set_property PACKAGE_PIN U3 [get_ports req_4]
set_property IOSTANDARD LVCMOS33 [get_ports req_4]
# MC1-51
set_property PACKAGE_PIN V2 [get_ports req_5]
set_property IOSTANDARD LVCMOS33 [get_ports req_5]
# MC1-52
set_property PACKAGE_PIN V3 [get_ports req_6]
set_property IOSTANDARD LVCMOS33 [get_ports req_6]
# MC1-53
set_property PACKAGE_PIN W2 [get_ports req_7]
set_property IOSTANDARD LVCMOS33 [get_ports req_7]
# MC1-54
set_property PACKAGE_PIN W1 [get_ports req_8]
set_property IOSTANDARD LVCMOS33 [get_ports req_8]
# MC1-55
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}]
# MC1-56
set_property PACKAGE_PIN  [get_ports {}]
set_property IOSTANDARD  [get_ports {}] # VCC 18 IN HERE
# MC1-57
...
set_property IOSTANDARD  [get_ports {}]
# MC2-15
set_property PACKAGE_PIN P5 [get_ports ACK]
set_property IOSTANDARD LVCMOS33 [get_ports ACK]
# MC2-16
set_property PACKAGE_PIN P6 [get_ports REQ]
set_property IOSTANDARD LVCMOS33 [get_ports REQ]
# MC2-17
set_property PACKAGE_PIN P4 [get_ports SRst]
set_property IOSTANDARD LVCMOS33 [get_ports SRst]
# MC2-18
set_property PACKAGE_PIN N5 [get_ports PRst]
...
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-21
set_property PACKAGE_PIN N3 [get_ports req_dn_tp]
set_property IOSTANDARD LVCMOS33 [get_ports req_dn_tp]
# MC2-22
set_property PACKAGE_PIN N2 [get_ports req_up_tp]
set_property IOSTANDARD LVCMOS33 [get_ports req_up_tp]
# MC2-23
set_property PACKAGE_PIN L5 [get_ports ack_tp]
set_property IOSTANDARD LVCMOS33 [get_ports ack_tp]
# MC2-24
...
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-38
set_property PACKAGE_PIN L3 [get_ports {control_imp}]
set_property IOSTANDARD LVCMOS33 [get_ports {control_imp}]
# MC2-39
set_property PACKAGE_PIN J2 [get_ports ]
set_property IOSTANDARD LVCM
OS33 [get_ports ]
# MC2-40
set_property PACKAGE_PIN K3 [get_ports C0]
set_property IOSTANDARD LVCMOS33 [get_ports C0]
# MC2-41
set_property PACKAGE_PIN K1 [get_ports {}]
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-42
set_property PACKAGE_PIN J5 [get_ports C1]
set_property IOSTANDARD LVCMOS33 [get_ports C1]
# MC2-43
set_property PACKAGE_PIN J1 [get_ports {}]
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-44
set_property PACKAGE_PIN H5 [get_ports C2]
...
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-59
set_property PACKAGE_PIN B1 [get_ports {ADC_SERIAL_DATA_OUT}]
set_property IOSTANDARD LVCMOS33 [get_ports {ADC_SERIAL_DATA_OUT}]
# MC2-60
...
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-63
set_property PACKAGE_PIN K4 [get_ports {ADC_SERIAL_DATA_IN}]
set_property IOSTANDARD LVCMOS33 [get_ports {ADC_SERIAL_DATA_IN}]
# MC2-64
...
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-66
set_property PACKAGE_PIN V15 [get_ports EN_TA]
set_property IOSTANDARD LVCMOS33 [get_ports EN_TA]
# MC2-67
set_property PACKAGE_PIN T16 [get_ports {Trigger}]
set_property IOSTANDARD LVCMOS33 [get_ports {Trigger}]
# MC2-68
set_property PACKAGE_PIN T14 [get_ports EN_TP]
set_property IOSTANDARD LVCMOS33 [get_ports EN_TP]
# MC2-69
set_property PACKAGE_PIN U16 [get_ports {}]
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-70
set_property PACKAGE_PIN T15 [get_ports EN_ARRAY]
set_property IOSTANDARD LVCMOS33 [get_ports EN_ARRAY]
# MC2-71
set_property PACKAGE_PIN V13 [get_ports {ADC_SPI_CLK}]
set_property IOSTANDARD LVCMOS33 [get_ports {ADC_SPI_CLK}]
# MC2-72
...
set_property IOSTANDARD LVCMOS33 [get_ports {}]
# MC2-75
set_property PACKAGE_PIN Y11 [get_ports {ADC_chip_select_n}]
set_property IOSTANDARD LVCMOS33 [get_ports {ADC_chip_select_n}]
# MC2-76
...
set_property IOSTANDARD LVCMOS33 [get_ports ack_0]

set_property IOSTANDARD LVCMOS33 [get_ports ack_1]
set_property IOSTANDARD LVCMOS33 [get_ports ack_2]
set_property IOSTANDARD LVCMOS33 [get_ports ack_3]
set_property IOSTANDARD LVCMOS33 [get_ports ack_4]
set_property IOSTANDARD LVCMOS33 [get_ports ack_5]
set_property IOSTANDARD LVCMOS33 [get_ports ack_6]
set_property IOSTANDARD LVCMOS33 [get_ports ack_7]
