...
#
# Generated by Vivado on Fri Dec 03 17:16:38 CET 2021
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../GAIA_opalkelly_interface.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../GAIA_opalkelly_interface.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/matteo/Desktop/GAIA-Vivado/GAIA_opalkelly_interface/GAIA_opalkelly_interface.cache/compile_simlib/vcs"
  fi
